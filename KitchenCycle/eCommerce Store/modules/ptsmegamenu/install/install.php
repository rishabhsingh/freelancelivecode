...
$res = (bool)Db::getInstance()->execute('
	CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'ptsmegamenu` (
...
');
$res &= (bool)Db::getInstance()->execute('
	CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'ptsmegamenu_lang` (
...
CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'ptsmegamenu_widgets` (
...
$res &= (bool)Db::getInstance()->execute('
	CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'ptsmegamenu_shop` (
...
/* install sample data */
$rows = Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS( 'SELECT id_ptsmegamenu FROM `'._DB_PREFIX_.'ptsmegamenu`' );
if( count($rows)==1&&file_exists(_PS_MODULE_DIR_ . 'ptsmegamenu/install/sample.php') ){
	include_once( _PS_MODULE_DIR_ . 'ptsmegamenu/install/sample.php' );
}	
/* END REQUIRED */
