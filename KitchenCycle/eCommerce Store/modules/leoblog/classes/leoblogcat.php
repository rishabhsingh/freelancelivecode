...
class Leoblogcat extends ObjectModel {
    ...
    public function delete() {
        ...
        $resultBlog  =  Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS('SELECT `id_leoblog_blog` as id FROM `' . _DB_PREFIX_ . 'leoblog_blog` WHERE `id_leoblogcat` IN (' . $list . ')');
    ...
    public function deleteSelection($menus) {
        ...
        foreach ($menus as $id_leoblogcat) {
            $objMenu = new Leoblogcat($id_leoblogcat);
