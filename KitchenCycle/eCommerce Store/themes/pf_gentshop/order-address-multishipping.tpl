...
{if !$opc}
			<p class="cart_navigation clearfix">
				...
				{/if}
		        <button type="submit" name="processAddress" class="button-exclusive btn btn-default pull-right"><span>{l s='Proceed to checkout'}<i class="icon-chevron-right right"></i></span></button>
			</p>
		</form>
{else}
	</div>
