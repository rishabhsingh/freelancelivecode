...
<div id="mywishlist">
	...
	<ul class="footer_links clearfix">
		<li class="pull-left">
			<a class="btn btn-outline-default" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}">
				<span>
		...
		<li class="pull-right">
			<a class="btn btn-outline-default" href="{$base_dir|escape:'html':'UTF-8'}">
				<span>
