	...
	<div class="primary_block row">
		...
		<div class="pb-left-column col-xs-12 col-sm-12 col-md-5 col-lg-5">
			...
			{if isset($images) && count($images) > 0}
				<!-- thumbnails -->
				<div id="views_block" class="clearfix col-xs-2 col-sm-2 {if isset($images) && count($images) < 2}hidden{/if}">
					<div id="thumbs_list">
						...
						<ul id="accessories-slider" class="product_list grid row">
							{foreach from=$accessories item=accessory name=accessories_list}
								{if ($accessory.allow_oosp || $accessory.quantity_all_versions > 0 || $accessory.quantity > 0) && $accessory.available_for_order && !isset($restricted_country_mode)}
									...
									<li class="col-xs-12 col-sm-4 col-md-3 col-lg-3 item product-box ajax_block_product{if $smarty.foreach.accessories_list.first} first_item{elseif $smarty.foreach.accessories_list.last} last_item{else} item{/if} product_accessories_description">
